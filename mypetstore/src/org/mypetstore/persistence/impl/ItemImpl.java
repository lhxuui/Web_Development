...
public class ItemImpl implements ItemDAO {
    ...
    private static final String getUpdateInventoryQuantityString = "SELECT QTY AS value FROM INVENTORY WHERE ITEMID = ?";
    @Override
    ...
    public int getInventoryQuantity(String itemId) {
        ...
        try {
            Connection connection = DBUtil.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(getUpdateInventoryQuantityString);
